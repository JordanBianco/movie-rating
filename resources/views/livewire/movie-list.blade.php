<div>
    {{-- Header - search --}}
    <header class="text-gray-100 border-b border-gray-700 py-16 mb-10">
        <h2 class="uppercase font-bold text-gray-300 text-center mb-2">Explore books</h2>
        ...
        <div class="flex items-center justify-center mx-auto">
            ...
            <div>
                <input
                    ...
                    class="p-2 border-gray-500 bg-transparent rounded-l-lg w-24 placeholder-gray-400 text-center"
                >
            </div>
            ...
            <div class="relative">
                <input
                    ...
                    class="p-2 border-gray-500 border-l-0 bg-transparent rounded-r-lg w-48 sm:w-72 placeholder-gray-400"
                >
    ...
    {{-- Sub-header - filters --}}
    <div class="flex justify-center sm:justify-between items-center text-gray-300 mb-6">
        <h2 class="uppercase font-bold text-yellow-400 hidden sm:block">Browse</h2>

        <div class="flex items-center space-x-3 sm:space-x-6">
            {{-- Più votati --}}
            <span wire:click.prevent="orderByVote" {{ $voted ? 'text-yellow-300' : '' }} class="cursor-pointer text-xs sm:text-sm uppercase font-semibold hover:text-yellow-400 ">TOP Movies</span>

            {{-- Risultati per pagina --}}
            <select
                class="border bg-transparent border-gray-700 bg-gray-800 uppercase text-xs sm:text-sm font-semibold rounded-lg"
                wire:model="perPage">
        ...
        <div class="relative">
            ...
            <div class="absolute bottom-0 w-full">
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <svg class="w-5 h-5 text-gray-400 hover:text-green-400 cursor-pointer" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>
                    </div>
                </div>
            </div>
        </div>
